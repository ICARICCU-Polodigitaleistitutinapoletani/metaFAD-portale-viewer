...
(function () {
    ...
    function ViewerController($rootScope, $log, $window, $scope, viewerFactory, MainService, objMetadato, detectItemInPage, serviceUUID, LoadingService, $uiMrFeedback) {
        ...
        var render = function () {
            ...
            vm.MetaMediaViewer.firstPageOdd = medias.firstPageOdd;
        ...
        vm.MetaMediaViewer = {
            ...
            options: {
                ...
                languages: METAFAD_VIEWER_CONFIG.languages
            },
            medias: []
        };
        ...
        var prepareDataForViewer = function (obj) {
            ...
            if (angular.isDefined(obj.physicalSTRU.firstPageOdd) && obj.physicalSTRU.firstPageOdd !== null) {
                mediaViewer.firstPageOdd = obj.physicalSTRU.firstPageOdd;
            }
            return mediaViewer;
        };
        var getMetadato = function (init, num, keyNode) {
        ...
        var metaMediaViewerGetMetadato = $scope.$on("metaMediaViewer:getMetadato", function (e, init, num, keyNode) {
